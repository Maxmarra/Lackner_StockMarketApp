...
//в бесплатных API возможен приход другого JSON
//в случае перерасхода запросов на минуту
//чтобы не было краша, делаем все поля
//с проверкой на null
//все поля в CompanyInfoDto тоже должны быть нулабельными
